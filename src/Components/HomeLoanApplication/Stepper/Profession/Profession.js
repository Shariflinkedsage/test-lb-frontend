      ...
      >
        <Form.Group controlId="organizationName" className="mt-2">
          {profession === "salaried" || profession === "business" ? (
            <div className="row">
              <div className="col-md-12 auto-complate">
                {" "}
                <Autocomplete
                  value={value}
            ...
            <div className="col-md-6">
              <Controller
                render={({ field }) => (
                  <Form.Control
                    {...field}
                    placeholder="Budget for property"
                    isInvalid={!!errors.xsalary}
                    size="lg"
                  />
                )}
                control={control}
              ...
              {errors.xsalary && (
                <Form.Control.Feedback type="invalid">
                  {errors.xsalary.message || "salary is not valid"}
                </Form.Control.Feedback>
              )}
            </div>
            <div className="col-md-6">
            ...
            <div className="col-md-6">
              <Controller
                render={({ field }) => (
                  <Form.Control
                    {...field}
                    placeholder="Amount of Self Finance"
                    isInvalid={!!errors.xsalary}
                    size="lg"
                  />
                )}
