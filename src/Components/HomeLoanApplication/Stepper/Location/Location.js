...
import Dhanmondi from "../../../../images/cities/Dhaka.jpg";
import Gulshan from "../../../../images/cities/Chittagong.jpg";
import Banani from "../../../../images/cities/Sylhet.jpg";
...
export default function Location({
  ...
  return (
    ...
    <div className={cx("list row d-flex justify-content-center g-0")}>
      ...
      >
        Which Area you are looking for your property?
      </p>
      <div
        // height={200}
        className={cx(style.container_lazyload, "col-4")}
        onClick={(e) => handleSubmit("Dhanmondi")}
      ...
      >
        <SuspenseImg
          ...
          alt="Dhanmondi"
        />
        <h6 className="text-center">Dhanmondi</h6>
      </div>
      <div
        height={200}
        className={cx(style.container_lazyload, "col-4")}
      ...
      >
        <SuspenseImg
          ...
          alt="Chitagong"
        />
        <h6 className="text-center">Gulshan 1</h6>
      </div>
      <div
        height={200}
        className={cx(style.container_lazyload, "col-4")}
        placeholder={<div>loading</div>}
        onClick={() => handleSubmit("Banani")}
      >
        <SuspenseImg
          src={Banani}
          style={{ width: "100px", height: "110px", borderRadius: "50%" }}
          alt="Chitagong"
        />
        <h6 className="text-center">Banani</h6>
      </div>
      <div
        height={200}
        className={cx(style.container_lazyload, "col-4")}
      ...
      >
        <SuspenseImg
          ...
          alt="Chitagong"
        />
        <h6 className="text-center">Gulshan 2</h6>
      </div>
      <div
        height={200}
      ...
      >
        <SuspenseImg
          ...
          alt="Chitagong"
        />
        <h6 className="text-center">Uttara</h6>
      </div>
      <div
        height={200}
        className={style.container_lazyload}
      ...
      >
        <SuspenseImg
          ...
          alt="Chitagong"
        />
        <h6 className="text-center">Mirpur</h6>
      </div>
      <div
        height={200}
        className={style.container_lazyload}
      ...
      >
        <SuspenseImg
          ...
          alt="Chitagong"
        />
        <h6 className="text-center">Purbachal</h6>
      </div>
    </div>
  );
}
